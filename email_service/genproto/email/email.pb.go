...
var fileDescriptor_74366e5b77a2734d = []byte{
	...
	0xcc, 0xd1, 0x07, 0x93, 0x7a, 0x05, 0x45, 0xf9, 0x25, 0xf9, 0x42, 0xac, 0x60, 0x8e, 0x52, 0x34,
	...
	,
}
...
func (m *Status) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Status) > 0 {
		...
		i = encodeVarintEmail(dAtA, i, uint64(len(m.Status)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Sms) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Phone) > 0 {
		i -= len(m.Phone)
		copy(dAtA[i:], m.Phone)
		i = encodeVarintEmail(dAtA, i, uint64(len(m.Phone)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Body) > 0 {
